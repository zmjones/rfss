...
p <- p + theme_bw()
ggsave(paste0(dir_prefix, "figures/cart_approximation.png"), p, width = 10, height = 8)
...
p <- p + theme_bw()
ggsave(paste0(dir_prefix, "figures/forest_approximation.png"), p, width = 10, height = 8)
ggsave(paste0(dir_prefix, "figures/forest_approximation_slides.png"), p, width = 8, height = 4)
